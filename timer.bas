...
40050 IF KEYPRESS$ = "S" OR KEYPRESS$ = "s" THEN ISWAITING% = 0: ISRUNNING% = 1: KEYPRESS$ = ""
40060 WEND
40070 REM KEYPRESS$ = "": ISRUNNING% = 1
...
60930 IF KEYPRESS$ = "S" OR KEYPRESS$ = "s" THEN GOTO 40010
60935 WEND
60940 KEY ON
60950 CLS
61000 END